      ...
      <div className="container mx-auto px-3 sm:px-4 py-2 flex flex-col md:flex-row items-center md:justify-between text-center md:text-left gap-1 md:gap-0">
        ...
        <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 md:gap-6 w-full md:w-auto">
          <div className="flex items-center gap-2 max-w-[160px] sm:max-w-[260px] truncate">
            <svg className="w-4 h-4 text-yellow-300 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path d="M2 5a2 2 0 012-2h12a2 2 0 012 2v1H2V5zM2 8h16v5a2 2 0 01-2 2H4a2 2 0 01-2-2V8z"/></svg>
            <span className="truncate">eazhisai@gmail.com</span>
          </div>

          <div className="flex items-center gap-2 max-w-[140px] sm:max-w-[220px] truncate">
            <svg className="w-4 h-4 text-yellow-300 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/></svg>
            <span className="truncate">+94 70 5738946</span>
          </div>
        ...
        <div className="flex items-center gap-2 mt-2 md:mt-0 justify-center md:justify-end w-full md:w-auto flex-wrap">
          <a href="#" className="text-gray-300 hover:text-white px-2 py-0.5 rounded-md">facebook</a>
          <a href="#" className="text-gray-300 hover:text-white px-2 py-0.5 rounded-md">x</a>
          <a href="#" className="text-gray-300 hover:text-white px-2 py-0.5 rounded-md">instagram</a>
          <a href="#" className="text-gray-300 hover:text-white px-2 py-0.5 rounded-md">linkedin</a>
        </div>
      </div>
    </div>
  );
